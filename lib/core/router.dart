    ...
    switch (settings.name) {
      case startUpViewRoute:
        return MaterialPageRoute(
          builder: (_) => view0.StartUpView(),
        );
      case loginViewRoute:
        return MaterialPageRoute(
          builder: (_) => view1.LoginView(),
        );
      case splashScreenViewRoute:
        return MaterialPageRoute(
          builder: (_) => view2.SplashScreenView(),
        );
      case profileViewRoute:
        return MaterialPageRoute(
          builder: (_) => view3.ProfileView(),
        );
      case userDetailsViewRoute:
        return MaterialPageRoute(
          builder: (_) => view4.UserDetailsView(),
        );
      case challengesViewRoute:
        return MaterialPageRoute(
          builder: (_) => view5.ChallengesView(),
        );
      case homeViewRoute:
        return MaterialPageRoute(
          builder: (_) => view6.HomeView(),
        );
      case searchViewRoute:
        return MaterialPageRoute(
          builder: (_) => view7.SearchView(),
        );
      case moreBooksViewRoute:
        return MaterialPageRoute(
          builder: (_) => view8.MoreBooksView(),
        );
      case bookViewRoute:
        return MaterialPageRoute(
          builder: (_) => view9.BookView(
            id: settings.arguments,
            text: settings.arguments,
            authors: settings.arguments,
            image: settings.arguments,
            previewLink: settings.arguments,
          ),
        );
      ...
      case bookReviewsViewRoute:
        return MaterialPageRoute(
          builder: (_) => view16.BookReviewsView(
            bookId: settings.arguments,
            tappedUserEmail: settings.arguments,
          ),
        );
      ...
      case comunintyInformationViewRoute:
        return MaterialPageRoute(
            builder: (_) => view22.ComunintyInformationView());
