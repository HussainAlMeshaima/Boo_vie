...
import 'package:boo_vi_app/views/comuninty_information/comuninty_information_view.dart' as view21;
...
import 'package:boo_vi_app/views/user_review_to_profile/user_review_to_profile_view.dart' as view24;
import 'package:boo_vi_app/views/completed_challenges/completed_challenges_view.dart' as view25;
import 'package:boo_vi_app/views/my_challanges/my_challanges_view.dart' as view26;
import 'package:boo_vi_app/views/introduction_screen/introduction_screen_view.dart' as view27;
import 'package:boo_vi_app/views/room/room_view.dart' as view28;
import 'package:boo_vi_app/views/comunity_members/comunity_members_view.dart' as view29;
import 'package:boo_vi_app/views/community_notifications/community_notifications_view.dart' as view30;
import 'package:boo_vi_app/views/comunity_active_challenges/comunity_active_challenges_view.dart' as view31;
import 'package:boo_vi_app/views/edit_community_rules_and_discription/edit_community_rules_and_discription_view.dart' as view32;
import 'package:boo_vi_app/views/community_challange/community_challange_view.dart' as view33;
import 'package:boo_vi_app/views/compleated_challange/compleated_challange_view.dart' as view34;
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case comunintyInformationViewRoute:
        return MaterialPageRoute(builder: (_) => view21.ComunintyInformationView());
      ...
      case userReviewToProfileViewRoute:
        return MaterialPageRoute(builder: (_) => view24.UserReviewToProfileView());
      case completedChallengesViewRoute:
        return MaterialPageRoute(builder: (_) => view25.CompletedChallengesView());
      case myChallangesViewRoute:
        return MaterialPageRoute(builder: (_) => view26.MyChallangesView());
      case introductionScreenViewRoute:
        return MaterialPageRoute(builder: (_) => view27.IntroductionScreenView());
      case roomViewRoute:
      ...
      case communityNotificationsViewRoute:
        return MaterialPageRoute(builder: (_) => view30.CommunityNotificationsView());
      case comunityActiveChallengesViewRoute:
        return MaterialPageRoute(builder: (_) => view31.ComunityActiveChallengesView());
      case editCommunityRulesAndDiscriptionViewRoute:
        return MaterialPageRoute(builder: (_) => view32.EditCommunityRulesAndDiscriptionView());
      case communityChallangeViewRoute:
        return MaterialPageRoute(builder: (_) => view33.CommunityChallangeView());
      case compleatedChallangeViewRoute:
        return MaterialPageRoute(builder: (_) => view34.CompleatedChallangeView());
      default:
