...
const String userDetailsViewRoute = 'userDetailsViewRoute';
const String challengesViewRoute = 'challengesViewRoute';
const String homeViewRoute = 'homeViewRoute';
const String searchViewRoute = 'searchViewRoute';
const String moreBooksViewRoute = 'moreBooksViewRoute';
const String bookViewRoute = 'bookViewRoute';
const String bookAuthorGridViewRoute = 'bookAuthorGridViewRoute';
const String bookInformationViewRoute = 'bookInformationViewRoute';
const String searchedViewRoute = 'searchedViewRoute';
const String comunintysViewRoute = 'comunintysViewRoute';
