    ...
    return ViewModelBuilder<UserReviewwViewModel>.reactive(
      ...
      builder:
        ...
        return Scaffold(
          ...
          shrinkWrap: true,
          slivers: [
            SliverAppBar(title: Text('Review')),
            SliverList(
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              SwitchListTile(activeColor: Theme.of(context).primaryColor, value: viewModel.editSpoiler, onChanged: (value) => viewModel.toggleSpoiler(value))
                                                                            ],
                                                                          ),
                                                                        )),
                                                                  );
