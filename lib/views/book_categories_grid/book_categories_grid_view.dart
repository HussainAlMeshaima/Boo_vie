    ...
    return ViewModelBuilder<BookCategoriesGridViewModel>.reactive(
      ...
      builder: (BuildContext context, BookCategoriesGridViewModel viewModel,
        ...
        return Scaffold(
          appBar: AppBar(
            title: Tooltip(
                message: 'Book Categories', child: Text('Book Categories')),
          ),
          body: FutureBuilder<BooksResponse>(
            future: viewModel.getBooksBycategories(categories),
            builder:
                (BuildContext context, AsyncSnapshot<BooksResponse> snapshot) {
              ...
              if (snapshot.hasData && snapshot.data.totalItems != 0) {
                ...
                newListOfBooks
                    .removeWhere((book) => book.volumeInfo.previewLink == null);

                newListOfBooks
                    .removeWhere((book) => book.volumeInfo.imageLinks == null);
                return Container(
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return newListOfBooks[index].volumeInfo.imageLinks != null
                          ? Tooltip(
                              message: newListOfBooks[index].volumeInfo.title,
                              child: Padding(
