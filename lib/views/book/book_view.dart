                        ...
                        FutureBuilder(
                            ...
                            builder: (BuildContext context,
                              ...
                              if (snapshot.hasData) {
                                ...
                                String author =
                                    snapshot.data.volumeInfo.authors != null
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () =>
                                            viewModel.pushBookInformationView(
                                                bookId: snapshot.data.id,
                                                buyLink: snapshot
                                                    .data.saleInfo.buyLink,
                                                webReaderLink: snapshot.data
                                                          ...
                                                          : Container(
                                                              child: Text(
                                                                description
                                                                        ...
                                                                        160
                                                                    ? '     ' +
                                                                        description.replaceAll(RegExp(r"<[^>]*>", multiLine: true, caseSensitive: true), '').substring(
                                                                            0,
                                                                            160) +
                                                                        '...'
                                                                    : description.replaceAll(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      viewModel
                                                                        ...
                                                                        authors:
                                                                            newListOfBooks[index].volumeInfo.authors[0] ??
                                                                                'No Authors',
                                                                        ...
                                                                        previewLink: newListOfBooks[index]
                                                                            ...
                                                                            .previewLink,
                                                                        bookId:
                                                                            newListOfBooks[index].id,
                                                                      );

                                                                      viewModel.pushBookView(
                                                                          authors: newListOfBooks[index].volumeInfo.authors[0] ??
                                                                              'No authors',
                                                                          previewLink: newListOfBooks[index]
                                                                              .volumeInfo
                                                                              .previewLink,
                                                                    ...
                                                                    child: Hero(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            image: DecorationImage(
                                                                              fit: BoxFit.cover,
                                                                              image: NetworkImage(newListOfBooks[index].volumeInfo.imageLinks.thumbnail),
                                                                            ),
