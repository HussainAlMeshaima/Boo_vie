            ...
            body: CustomScrollView(
              ...
              slivers: [
                SliverAppBar(
                  ...
                  title: Tooltip(
                      message: 'Challenges tab', child: Text('Challenges')),
                  bottom: TabBar(
                    tabs: [
                      Tooltip(
                                              ...
                                              viewModel.pushGlobalChallengeView(
                                                  ...
                                                  numberOfCommunitiesWhoHasThatChallangeCount:
                                                      globalChallangesDocs[index]
                                                          [
                                                          'numberOfCommunitiesWhoHasThatChallangeCount'],
                                                  numberOfCommentsCount: globalChallangesDocs[index]
                                                      ['numberOfCommentsCount'],
                                                  trophiesCount:
                                                      globalChallangesDocs[index]
                                                          ['trophiesCount'],
                                                  challengeDiscription: globalChallangesDocs[index]
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        snapshot
                                                                            .data
                                                                            .docs[index]['numberOfPeopleWhoHasThatChallengeCount']
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                            color:
                                                                                Colors.white),
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        snapshot
                                                                            .data
                                                                            .docs[index]['challengeLikeCounter']
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                            color:
                                                                                Colors.white),
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        snapshot
                                                                            .data
                                                                            .docs[index]['numberOfCommentsCount']
                                                                            .toString(),
                                                                        style: TextStyle(
                                                                            color:
                                                                                Colors.white),
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      image:
                                                                        ...
                                                                        colorFilter: ColorFilter.mode(
                                                                            Colors.black45,
                                                                            BlendMode.darken),
                                                                        image: NetworkImage(globalChallangesDocs[index]
                                                                            [
                                                                            'challengeImage']),
                                                                      ),
                                                                    ),
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                globalChallangesDocs[index]['challengeName'],
                                                                                overflow: TextOverflow.ellipsis,
                                                                                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.white),
                                                                              ),
                                                                              Text(
                                                                                globalChallangesDocs[index]['challengeAuthors'],
                                                                                overflow: TextOverflow.ellipsis,
                                                                    ...
                                                                    GestureDetector(
                                                                      onTap: () =>
                                                                          viewModel
                                                                              .pushBookView(
                                                                        authors:
                                                                            userChallangesDocs[index]['authors'],
                                                                        ...
                                                                        id: userChallangesDocs[index]
                                                                            ...
                                                                            'id'],
                                                                        bookTitle:
                                                                            userChallangesDocs[index]['title'],
                                                                        previewLink:
                                                                            userChallangesDocs[index]['previewLink'],
                                                                      ),
                                                                      child:
                                                                          Container(
                                                                        height:
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            ...
                                                                            image: DecorationImage(fit: BoxFit.cover, image: NetworkImage(userChallangesDocs[index]['bookImage']))),
                                                                      ),
                                                                    ),
                                                                    SizedBox(
                                                                      width: 12,
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              Container(
                                                                                height: 47,
                                                                                width: 155,
                                                                                decoration: BoxDecoration(color: Theme.of(context).brightness == Brightness.dark ? Color(0xff262626) : Color(0xffE8E8E8), borderRadius: BorderRadius.circular(7)),
                                                                                child: Center(
                                                                                  child: Row(
                                                                              ...
                                                                              StreamBuilder(
                                                                                stream: viewModel.getThatBookEmoji(snapshot.data.docs[index]['id']),
